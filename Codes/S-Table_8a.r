...
edat <- read.csv(file="editeddata01_S1.csv")
load(file="presurv_edited.RData")

##

edat <- edat[edat$x1=="C1"|edat$x1=="C2"|edat$x1=="C6"|edat$x1=="C11",]
...
presurv01 <- presurv[((presurv$x0=="C1")|(presurv$x0=="C2")|(presurv$x0=="C6")|(presurv$x0=="C11")),]
...
edat <- read.csv(file="editeddata02_S1.csv")
load(file="presurv_edited.RData")

##

edat <- edat[edat$x1=="C1"|edat$x1=="C3"|edat$x1=="C7"|edat$x1=="C11",]
...
presurv01 <- presurv[((presurv$x0=="C1")|(presurv$x0=="C3")|(presurv$x0=="C7")|(presurv$x0=="C11")),]
...
edat <- read.csv(file="editeddata03_S1.csv")
load(file="presurv_edited.RData")

##

edat <- edat[edat$x1=="C1"|edat$x1=="C4"|edat$x1=="C8"|edat$x1=="C11",]
...
presurv01 <- presurv[((presurv$x0=="C1")|(presurv$x0=="C4")|(presurv$x0=="C8")|(presurv$x0=="C11")),]
...
edat <- read.csv(file="editeddata04_S1.csv")
load(file="presurv_edited.RData")

##

edat <- edat[edat$x1=="C1"|edat$x1=="C5"|edat$x1=="C9"|edat$x1=="C11",]
...
presurv01 <- presurv[((presurv$x0=="C1")|(presurv$x0=="C5")|(presurv$x0=="C9")|(presurv$x0=="C11")),]
