...
edat <- read.csv(file="editeddata01_S2.csv")
...
edat <- read.csv(file="editeddata02_S2.csv")
load(file="presurv_edited.RData")
...
edat <- read.csv(file="editeddata03_S2.csv")
load(file="presurv_edited.RData")
...
edat <- read.csv(file="editeddata04_S2.csv")
load(file="presurv_edited.RData")
